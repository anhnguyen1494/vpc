...
Route::group(['namespace' => 'Frontend'],function(){
    ...
    Route::get('t/{slug_cate}',['as' => 'frontend.category', 'uses' => 'ArticleController@category']);
    Route::get('t/{slug_cate}/{slug_article}',['as' => 'frontend.article.show', 'uses' => 'ArticleController@show']);
